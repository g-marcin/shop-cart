...
if(IS_BROWSER_ENVIRONMENT){
  ...
  function renderCart() {
    ...
    function renderBrandBoxes() {
      ...
      globalStateObject._cart = globalStateObject._cart.map((extendedProduct) => {
        ...
        const brandBox = getBrandBoxHTMLMarkup({brand, brandName:BRAND_LABEL, brandTotal, isChecked});
    ...
    function renderCartProducts() {
      ...
      globalStateObject._cart.forEach((brandGroup) => {
        ...
        brandGroup.brandProducts.forEach((brandProduct) => {
          ...
          const manufacturerProduct = getManufacturerProductHTMLMarkup({id, brand, title, price, count, isChecked});
